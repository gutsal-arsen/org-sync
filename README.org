* Changes
  - The current version might not work with anything else but Redmine. To get it
    to work with Redmine you have to set the dictionary =os-cons-state-todo-dict=
* Introduction
